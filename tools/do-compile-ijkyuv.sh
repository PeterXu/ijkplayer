...
FF_BUILD_SOURCE="$BASEDIR/ijkmedia/ijkyuv"
FF_BUILD_WSPACE="$FF_BUILD_ROOT/build/ijkyuv-$FF_ARCH"
FF_BUILD_OUTPUT="$FF_BUILD_ROOT/build/ijkyuv-$FF_ARCH/output"
...
if [ "$FF_PLATFORM" = "osx" ]; then
    ...
    FF_CFG_FLAGS="$FF_CFG_FLAGS -DENABLE_JPEG=OFF"
