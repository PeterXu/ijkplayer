...
if [ "#$TARGET" = "#" ]; then
  ...
  #xcodebuild -project $PROJECT -target $TARGET $OPTION -sdk macosx -arch arm64 build
  xcodebuild -project $PROJECT -target $TARGET $OPTION -sdk macosx -arch x86_64 build
  exit 0
